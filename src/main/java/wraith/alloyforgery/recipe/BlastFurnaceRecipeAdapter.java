...
import wraith.alloyforgery.mixin.SingleStackRecipeAccessor;
...
public class BlastFurnaceRecipeAdapter implements RecipeInjector.AddRecipes {
    ...
    public void addRecipes(RecipeInjector instance) {
        ...
        Collection<RecipeEntry<AlloyForgeRecipe>> alloyForgeryRecipes = manager.getAllOfType(AlloyForgeRecipe.Type.INSTANCE);

        for (RecipeEntry<BlastingRecipe> recipeEntry : manager.getAllOfType(RecipeType.BLASTING)) {
